...
tools: OpenCode file editing, shell, search, and any available browser or Playwright inspection tools
model: sonnet
---
...
In OpenCode, use whichever browser or Playwright inspection tools are available in
...
```
.opencode/context/coding-rules.md    # coding rules — preferred OpenCode location
...
```
.opencode/context/project-facts.md   # preferred OpenCode location
...
### OpenCode Validation Workflow

```javascript
// 1. Navigate to the target page using whichever browser or Playwright
//    inspection tool is available in the OpenCode environment.
